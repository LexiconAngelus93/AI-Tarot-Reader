...
class EigenvalueCalculatorTest {
    ...
    fun testCalculateEigenvalue() {
        ...
        val eigenvalue = EigenvalueCalculator.calculateEigenvalue(cardDrawings, cards, positions)
    ...
    fun testCalculateEigenvalueWithEmptyDrawings() {
        ...
        val eigenvalue = EigenvalueCalculator.calculateEigenvalue(emptyList(), emptyList(), emptyList())
